...
import Style from "./styles/Main_course.module.css";
import {
    Container,
    Row,
    CardColumns,
...
function Main_courses() {
    ...
    const edit1 = (e, Item) => {
        const doc = db
            ...
            .doc(Item.id);
        if (image) {
            const storageRef = storage.ref(`images/Main-courses`);
        ...
        <div className={Style.starters}>
            <div className={Style.background_image_admin}>
                <div className={Style.header_container}>
                    ...
                    <h1 className={Style.order_header}>MAIN COURSE</h1>
